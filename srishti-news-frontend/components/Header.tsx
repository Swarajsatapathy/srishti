        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-2 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 bg-[#FF0000] rounded-md flex items-center justify-center hover:opacity-80 transition"
            >
              <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888] rounded-md flex items-center justify-center hover:opacity-80 transition"
            >
              <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-8 h-8 bg-[#0088cc] rounded-md flex items-center justify-center hover:opacity-80 transition"
            >
              <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
